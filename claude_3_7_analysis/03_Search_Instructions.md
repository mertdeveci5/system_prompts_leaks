# Claude 3.7 - Search Instructions

This document provides comprehensive guidelines on using search tools, determining query complexity, and conducting research.
