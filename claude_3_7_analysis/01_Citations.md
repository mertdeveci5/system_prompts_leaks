# Claude 3.7 - Citation Instructions

This document outlines the rules for citing sources when the assistant's response is based on content from search tools.
